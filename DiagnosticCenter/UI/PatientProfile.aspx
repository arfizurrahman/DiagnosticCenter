<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatientProfile.aspx.cs" Inherits="DiagnosticCenter.UI.PatientProfile" %>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="PatientProfile.aspx"><i class="fa fa-user"></i> Patient profile</a></li>
        ...
        <li class="active"><a href="UnpaidBillReport.aspx"><i class="fa fa-money"></i> <span>UnpaidBill</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
...
<section class="content-header">
 ...
 <div class="row">
    ...
    <label class="control-label col-sm-4" for="patientCodeText">Enter patient code.</label>
    <div class="col-sm-8"> 
      <input type="text" class="form-control" id="patientCodeText" required="" placeholder="patient code" runat="server"/>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <asp:Button class="btn btn-md btn-primary" Text="Search" runat="server" OnClick="searchButton_Click" />
    </div>
  </div>
          </div>   
                    <div class="form-group">
  ...
  <div class="form-group">
    <label class="control-label col-sm-4"  for="contactNoText">Name:</label>
    <div class="col-sm-8">
         <label class="control-label" id="nameLabel" for="" runat="server"></label> 
    ...
    <div class="col-sm-8"> 
      <label class="control-label" id="contactLabel" runat="server"></label> 
    </div>
  </div>
                            <div class="form-group">
    <label class="control-label col-sm-4" >Age: </label>
    <div class="col-sm-8"> 
      <label class="control-label" id="ageLabel"  runat="server"></label> 
    </div>
  </div>
                            <div class="form-group">
    <label class="control-label col-sm-4">Address:</label>
    <div class="col-sm-8"> 
     <label class="control-label" id="addressLabel"  runat="server"></label> 
    </div>
   ...
   <div class="col-sm-6">
            ...
            <div class=" breadcrumb">
                <h4>List of Tests Done By The Patient</h4>
            </div>

            <asp:GridView ID="patientTestGridView" runat="server" Width="500px" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4">
