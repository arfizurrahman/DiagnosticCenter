<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoctorsProfile.aspx.cs" Inherits="DiagnosticCenter.UI.DoctorsProfile" %>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class=""><a href="PatientProfile.aspx"><i class="fa fa-user"></i> Patient profile</a></li>
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="DoctorsProfile.aspx"><i class="fa fa-user"></i> Doctors Profile</a></li>
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Doctors Profile</li>
 ...
 <div class="row">
    ...
    <label class="control-label col-sm-4" for="contactNoText">Enter Contact No.</label>
    <div class="col-sm-8"> 
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8"> 
      <label class="control-label" id="emailLabel"  runat="server"></label> 
    </div>
  </div>
                            <div class="form-group">
    ...
    <div class="col-sm-8"> 
      <label class="control-label" id="qualificationLabel"  runat="server"></label> 
    </div>
  </div>
                            <div class="form-group">
    <label class="control-label col-sm-4" >Fee: </label>
    <div class="col-sm-8"> 
      <label class="control-label" id="feeLabel"  runat="server"></label> 
    </div>
  </div>
 <div class="form-group">
    ...
    <div class="col-sm-8"> 
     <label class="control-label" id="avalLabel"  runat="server"></label> 
    </div>
</div>
                            </div>
                            </div>
