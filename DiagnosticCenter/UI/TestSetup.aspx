<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="TestSetup.aspx.cs" Inherits="DiagnosticCenter.UI.TestSetup" %>
...
<div class="wrapper">
  ...
  <div class="form-group">
    <label class="control-label col-sm-4" for="testNameTextBox">Test Name</label>
    <div class="col-sm-8">
        <input type="text" class="form-control" id="testNameTextBox" required placeholder="Test Name" runat="server"/>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
  <label class="control-label col-sm-4" for="">Test Type</label>
      <div class="col-sm-8">
          <asp:DropDownList class="form-control" placeholder="--Select--" ID="testTypeDropDownList" runat="server" required="" >
  ...
  <div class="col-sm-6">
            ...
            <asp:GridView ID="testGridView" DataKeyNames="Name" OnRowCommand="testGridView_RowCommand" runat="server" Width="540px" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                               <asp:LinkButton ID="LnkBtnEdit" CommandName="EditRow" CommandArgument='<%# Eval("Name") %>' runat="server" OnClick="editBtn_Click" CausesValidation="false">Edit</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                               <asp:LinkButton ID="LnkBtnRemove" CommandName="DeleteRow" CommandArgument='<%# Bind("Name") %>' runat="server" OnClientClick="return confirm('Are you sure?')" CausesValidation="false">Delete</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
