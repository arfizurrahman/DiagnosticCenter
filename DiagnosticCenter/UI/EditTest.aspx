<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditTest.aspx.cs" Inherits="DiagnosticCenter.UI.EditTest" %>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Test Info</li>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      ...
      <label class="control-label col-sm-4" for=""></label> 
    <div class="col-sm-8">
        <a href="TestSetup.aspx">Back To Previous Page</a>
    </div>
  </div>
