<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditDoctor.aspx.cs" Inherits="DiagnosticCenter.UI.EditDoctor" %>
...
<section class="content-header">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <asp:Button class="btn btn-md btn-primary" Text="Update" runat="server" OnClick="updateButton_Click" />
  ...
  <div class="form-group">
   ...
   <div class="form-group">
      <label class="control-label col-sm-4" for=""></label> 
    <div class="col-sm-8">
      <a href="AddDoctor.aspx">Back To Previous Page</a>
    </div>
  </div>
