<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnpaidBillReport.aspx.cs" Inherits="DiagnosticCenter.UI.UnpaidBillReport" %>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Unpaid Bill Report</li>
         
      </ol>
    </section>
    <br>
     <section class="col-lg-12 connectedSortable">
         <form class="form-horizontal" runat="server" id="unpaidBillForm">
         <div class="row">
                <div class="col-lg-12">
  ...
  <div class="form-group">
    <label class="control-label col-sm-4" runat="server" Text="From Date">From</label>
    <div class="col-sm-8">
        <input type="text" value="dd/mm/yyyy" id="fromDateTextBox" class="datepicker" runat="server" />
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-4" runat="server" Text="To Date">To</label>
    <div class="col-sm-8"> 
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <asp:Button class="btn btn-md btn-primary" Text="Show" runat="server" OnClick="showButton_Click" />
    </div>
  </div>
  <div class="form-group">
      <label class="control-label col-sm-4" for=""></label> 
        ...
        <h4><span class="label label-danger" id="messageLabel2" runat="server"></span></h4>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Bill Amount">
                            <ItemTemplate>
                                <asp:Label runat="server"><%#Eval("UnpaidBill") %></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle Font-Bold="True" Font-Italic="True" ForeColor="#0099FF" HorizontalAlign="Center" />
                           ...
                           <div class="col-sm-2"><asp:Button ID="pdfButton" runat="server" Height="26px" OnClick="pdfButton_Click" Text="PDF" Width="65px" /></div>
                             <div class="form-group">
    <label class="control-label col-sm-4" for="totalTextBox">Total</label>
    <div class="col-sm-2"> 
      <input type="number" class="form-control" id="totalTextBox" runat="server"/>
    </div>
  </div>
                            </div>
                            </div>
   ...
   <script>
       $(document).ready(function () {
           ...
           $("#unpaidBillForm").validate({
               ...
               messages: {
                   fromDateTextBox: "Please enter test name",
                   toDateTextBox: "Please enter fee",
