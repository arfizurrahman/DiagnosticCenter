<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddPatient.aspx.cs" Inherits="DiagnosticCenter.UI.AddPatient" %>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="AddPatient.aspx"><i class="fa fa-user-plus"></i> Add Patient</a></li>
            <li><a href="PatientProfile.aspx"><i class="fa fa-user"></i> Patients Profile</a></li>
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Pateint</li>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
        <input type="text" class="form-control" id="nameTextBox" required placeholder="Patient Name" runat="server"/>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8"> 
      <input type="text" class="form-control" id="addressTextBox" required="" placeholder="Address" runat="server"/>
    </div>
  </div>
    <div class="form-group">
    <label class="control-label col-sm-4" for="ageTextBox">Age</label>
    <div class="col-sm-8"> 
      <input type="number" class="form-control" id="ageTextBox" required="" placeholder="Age" runat="server"/>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
   ...
   <div class="col-sm-6">
            ...
            <asp:GridView DataKeyNames="ContactNo" OnRowCommand="patientGridView_RowCommand" ID="patientGridView" runat="server" Width="540px" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Code">
                            <ItemTemplate>
                                ...
                                <asp:LinkButton ID="LnkBtnTestRequest" CommandName="TestRequest" CommandArgument='<%# Eval("Code") %>' runat="server" OnClick="codeBtn_Click" CausesValidation="false"><%#Eval("Code")%></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
