<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestRquestByPatient.aspx.cs" Inherits="DiagnosticCenter.UI.TestRquestByPatient" %>
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Test By Pateint</li>
  ...
  <div class="form-group">
    <label class="control-label col-sm-4" for="codeTextBox">Patient Code</label>
    <div class="col-sm-8">
        <input type="text" class="form-control" id="codeTextBox" required placeholder="Patient Code" runat="server"/>
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-4" for="selectTestDropDownList">Select Test</label>
    <div class="col-sm-8"> 
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8"> 
      <input type="text" class="form-control" id="feeTextBox" required="" disabled placeholder="Fee" runat="server"/>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <asp:Button class="btn btn-md btn-primary" Text="Add" runat="server" OnClick="addButton_Click" />
    </div>
  </div>
  <div class="form-group">
      <label class="control-label col-sm-4" for=""></label> 
    <div class="col-sm-8">
        ...
        <h4><span class="label label-danger" id="messageLabel2" runat="server"></span></h4>
            ...
            <div class=" breadcrumb">
                ...
                <asp:GridView ID="testEntryGridView" runat="server" AutoGenerateColumns="False" Width="500px" Height="150px">
    ...
    <div class="col-sm-3"> 
      <input type="text" class="form-control" id="totalTextBox" required="" disabled placeholder="Total fee" runat="server"/>
    </div>
  </div>
                 <div class="row"><div class="col-lg-10"><div></div><div class="form-group">
