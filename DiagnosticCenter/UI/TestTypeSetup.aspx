<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="TestTypeSetup.aspx.cs" Inherits="DiagnosticCenter.UI.TestTypeSetup" %>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class=" treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="PatientProfile.aspx"><i class="fa fa-user-o"></i> Patient Profile</a></li>
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="DoctorsProfile.aspx"><i class="fa fa-user-o"></i> Doctors Profile</a></li>
 ...
 <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Test Type Setup</li>
         
      </ol>
    </section>
    <br>
       <section class="col-lg-12 connectedSortable">
           <form class="form-horizontal" runat="server" id="testTypeForm">
         <div class="row">
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4>Test Type Detailes</h4>
                        </div>
                        <div class="panel-body">
  
  <div class="form-group">
    <label class="control-label col-sm-4" for="typeNameTextBox">Test Type Name</label>
    <div class="col-sm-8">
        <input type="text" class="form-control" id="typeNameTextBox" placeholder="Test Type Name"  required runat="server"/>
    </div>
  </div>
    ...
    <div class="col-sm-8">
        ...
        <div class="col-sm-6">
            ...
            <div class=" breadcrumb">
                <h4>List of Test Type</h4>
            </div>
             <asp:GridView ID="typeNameGridView" DataKeyNames="TypeName"  runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Width="363px" OnRowCommand="typeNameGridView_RowCommand">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                               <asp:LinkButton ID="LnkBtnEdit" CommandName="EditRow" CommandArgument='<%# Eval("TypeName") %>' runat="server" OnClick="editBtn_Click" CausesValidation="false">Edit</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                               <asp:LinkButton ID="LnkBtnRemove" CommandName="DeleteRow" CommandArgument='<%# Bind("TypeName") %>' runat="server" OnClientClick="return confirm('Are you sure?')" CausesValidation="false">Delete</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
   ...
   <script>
       $(document).ready(function () {
           ...
           $("#testTypeForm").validate({
               ...
               messages: {
                   typeNameTextBox: "Please enter type name"
