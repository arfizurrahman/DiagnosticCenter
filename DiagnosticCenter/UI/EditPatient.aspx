<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPatient.aspx.cs" Inherits="DiagnosticCenter.UI.EditPatient" %>
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Pateint</li>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <asp:Button class="btn btn-md btn-primary" Text="Save" runat="server" OnClick="updateButton_Click" />
 ...
 <div class="form-group">
      <label class="control-label col-sm-4" for=""></label> 
    <div class="col-sm-8">
        <a href="AddPatient.aspx">Back To Previous Page</a>
    </div>
  </div>
