<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDoctor.aspx.cs" Inherits="DiagnosticCenter.UI.AddDoctor" %>
...
<section class="content-header">
    ...
    <br>
     <section class="col-lg-12 connectedSortable">
         <form class="form-horizontal" runat="server" id="patientForm">
         <div class="row">
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4>Doctor Detailes</h4>
                        </div>
                        <div class="panel-body">

  <div class="form-group">
    <label class="control-label col-sm-4" for="nameTextBox">Name</label>
    <div class="col-sm-8">
        <input type="text" class="form-control" id="nameTextBox" required placeholder="Name" runat="server"/>
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-4" for="emailTextBox">Email</label>
    <div class="col-sm-8">
        <input type="email" class="form-control" id="emailTextBox" required placeholder="Email" runat="server"/>
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-4" for="contactNoText">Contact No.</label>
    <div class="col-sm-8"> 
      <input type="number" class="form-control" id="contactNoText" required="" placeholder="Contact no" runat="server"/>
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-4" for="qualificationTextBox">Qualtifications</label>
    <div class="col-sm-8"> 
      <textarea type="text" class="form-control" id="qualificationTextBox" required="" placeholder="Qualtifications" runat="server"></textarea>
    </div>
  </div>
    
      <div class="form-group">
    <label class="control-label col-sm-4" for="feeTextBox">Fee</label>
    <div class="col-sm-8"> 
      <input type="number" class="form-control" id="feeTextBox" required="" placeholder="Fee" runat="server"/>
    </div>
  </div>                  

    <div class="form-group">
    <label class="control-label col-sm-4" for="addressTextBox">Address</label>
    <div class="col-sm-8"> 
      <textarea type="text" class="form-control" id="addressTextBox" required="" placeholder="Address" runat="server"></textarea>
    </div>
  </div>
        ...
        <div class="bootstrap-timepicker">
                <div class="form-group">
                  <label class="control-label col-sm-4" for="availableFromTextBox">Available From</label>
                  <div class="input-group col-sm-8">
                      <input type="text" id="availableFromTextBox" value="12:00" runat="server" class="form-control timepicker"/>
           ...
           <div class="bootstrap-timepicker">
                <div class="form-group">
                  <label class="control-label col-sm-4" for="availableToTextBox">Available To</label>
                  <div class="input-group col-sm-8">
                      <input type="text" id="availableToTextBox" value="12:00" runat="server" class="form-control timepicker"/>
  ...
  <div class="form-group">
   ...
   <div class="col-sm-6">
            ...
            <asp:GridView DataKeyNames="ContactNo" OnRowCommand="doctorGridView_RowCommand"  ID="doctorGridView" runat="server" Width="540px" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4">
